-- Optional reference scenario metadata for MANDATE v3.
...
values (
  ...
  '{"parliament_seats":640,"campaign_weeks":2,"starting_player_poll":36.8,"currency":"GBP","requires_cabinet_formation":true}'::jsonb
)
